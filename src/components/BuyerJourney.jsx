...
const DEFAULT_COMBINED = [
  ...
  { id: "c21", type: "stage", eventType: "action", title: "Client books pre-production call",
    desc: "TidyCal embed on Well Done page → scheduled into Sophie's (production manager) calendar." },
  ...
  { id: "c23", type: "stage", eventType: "meeting", title: "Pre-production meeting",
    desc: "Sophie + account manager + client. AI notetaker records. Questions on goals, aspirations, fears, desires, USP, industry — what's changed since last time for repeat clients.",
