  ...
  return wrap(
    <>
      ...
      {narrow ? (
        ...
        // AM sidebar shrunk from 380 -> 340 so the table pane gets ~40px
        // more for the video-name column. The AM card is still comfortable
        // at 340 (photo + name + role + phone + email rows + booking button).
