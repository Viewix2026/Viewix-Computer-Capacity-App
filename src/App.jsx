    ...
    <div style={{maxWidth:1100,margin:"0 auto",padding:"32px 40px"}}>
      ...
      <div style={{marginBottom:24,background:"#131825",border:"1px solid #1E2A3A",borderRadius:12,overflow:"hidden"}}>
        ...
        {showInstructions&&(<div style={{padding:"0 20px 20px",fontSize:13,color:"#8899AB",lineHeight:1.7}}>
          <div style={{display:"grid",gap:12}}>
            ...
            <div style={{display:"flex",gap:10}}><span style={{color:"#0082FA",fontWeight:800,fontSize:14,minWidth:20}}>4.</span><span>Please add notes and feedback directly into <span style={{color:"#0082FA",fontWeight:600}}>Frame.io</span>. This will be easier to see the audit trail for changes for videos. To add comments into Frame.io, simply add a note into the comment box and the system will automatically time stamp it.</span></div>
            <div style={{display:"flex",gap:10}}><span style={{color:"#0082FA",fontWeight:800,fontSize:14,minWidth:20}}>5.</span><span>You can also add quick notes in the <span style={{color:"#0082FA",fontWeight:600}}>Notes</span> column of the table below.</span></div>
          </div>
      ...
      :(<div style={{overflowX:"auto",background:"#131825",borderRadius:12,border:"1px solid #1E2A3A"}}><table style={{width:"100%",borderCollapse:"collapse",fontSize:13}}>
        <thead><tr>
          ...
          <th style={{padding:"12px 14px",fontSize:10,fontWeight:700,color:"#0082FA",letterSpacing:"0.06em",textTransform:"uppercase",borderBottom:"2px solid #1E2A3A",textAlign:"left",background:"rgba(0,130,250,0.04)"}}>Notes ✎</th>
        </tr></thead>
        <tbody>{delivery.videos.map(v=>{
          ...
          return(<tr key={v.id}>
            ...
            <td style={{padding:"8px 10px",borderBottom:"1px solid #1E2A3A",background:"rgba(0,130,250,0.04)"}}><input value={v.notes||""} onChange={e=>updateField(v.id,"notes",e.target.value)} placeholder="Add notes..." style={{width:"100%",padding:"6px 10px",borderRadius:6,border:editableBorder,background:editableBg,color:"#E8ECF4",fontSize:12,outline:"none"}}/></td>
          </tr>);})}
        </tbody>
      </table></div>)}
